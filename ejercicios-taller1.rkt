...
;; se incluye el par (sim valor) si (F sim) es igual al emento valor en la misma posición en L2.
;; <listas> := ()
;;           := (<valor-de-scheme> <listas>)
...
(define mapping (lambda (F L1 L2)
    (cond
      [(or (null? L1) (null? L2)) '()]
      [(= (F (car L1)) (car L2)) (cons (list (car L1) (car L2)) (mapping F (cdr L1) (cdr L2)))]
